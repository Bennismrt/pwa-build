                ...
                <div className='w-80 mx-auto'>
                    <form>
                        <div className='w-full flex flex-col'>
                            <div className='my-4 font-semibold'>Enter OTP</div>
                            <div className='w-full flex flex-row space-x-4'>
                                <div className='w-full flex items-center justify-center'>
                                    <input className='w-full border p-2 rounded-xl text-center text-xl'/>
                                </div>
                                <div className='w-full flex items-center justify-center'>
                                    <input className='w-full border p-2 rounded-xl text-center text-xl'/>
                                </div>
                        ...
                        <button className='mt-2 py-1 mt-6 bg-sky-600 w-full rounded-md text-gray-200 text-[500] hover:bg-sky-700' onClick={handleSetPassword}>Set Password</button>

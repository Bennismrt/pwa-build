                ...
                <div className='w-80 mx-auto'>
                    <form>
                      <label className='relative'>
                        ...
                        <button className='mt-2 py-1 mt-6 bg-sky-600 w-full rounded-md text-gray-200 text-[500] hover:bg-sky-700' onClick={handleGetOTP}>Send OTP</button>
